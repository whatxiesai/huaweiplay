...
public class CategoryToolBean {
    ...
    public static class CategoryToolAppBean {
        ...
        /** 应用集合 */
        private List<com.example.administrator.huawei.bean.AppBean> appList ;
        private int type = 0 ;

        public CategoryToolAppBean(String title, List<String> iconList, List<com.example.administrator.huawei.bean.AppBean> appList, int type) {
            this.title = title;
